...
export const PIP_OVERLAYS = [
	...
	},
	{
		...
		icon: '',
		template: 'pip_shadow',
		defaults: { blur: 20, offsetX: 5, offsetY: 5, color: 'rgba(0,0,0,0.6)', spread: 0, radius: 0, side: 'outside' },
		schema: [
			{ key: 'side', label: 'Side', type: 'select', options: ['inside', 'outside'], default: 'outside' },
	...
	},
	{
		...
		icon: '',
		template: 'pip_glow',
		defaults: { color: '#e63946', intensity: 15, width: 0, pulse: true, pulseSpeed: 2, minOpacity: 0.4, radius: 0, side: 'outside' },
		schema: [
			{ key: 'side', label: 'Side', type: 'select', options: ['inside', 'outside'], default: 'outside' },
			{ key: 'color', label: 'Color', type: 'color', default: '#e63946' },
