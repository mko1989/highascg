...
Technical deep dives for integrators and developers. Operators should start at [../README.md](../README.md).
...
| PIP overlays | [pip-overlay-outside-border.md](pip-overlay-outside-border.md) — outside border / glow placement (do not regress) |
...
| Operator CEF bridge | [cef-interactive-bridge.md](cef-interactive-bridge.md) — X11→CDP, trace env, keyboard modifiers |
| Audio (detailed) | [audio/](audio/) — ALSA, PipeWire, JACK, Caspar consumers |
| Vendor PDFs | [vendor/](vendor/) — PixelFlow / switcher manuals |

Operator audio entry point: [../guides/audio/audio-setup-guide.md](../guides/audio/audio-setup-guide.md).
