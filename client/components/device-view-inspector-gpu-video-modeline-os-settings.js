/**
 * Settings/patch helpers for the GPU video modeline inspector section:
 * per-port OS setting reads, apply-os patch builders, Caspar-mode OS dims,
 * sibling-port lookup, and detected-mode option formatting.
 */
...
import { casparVideoModeToOsModeAndRate } from './device-view-destinations-inspector.js'
...
/** Normalize a detected display mode row into a select-option descriptor (or null). */
export function formatModeOption(m) {
