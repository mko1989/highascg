...
export function renderMappingsBand(ctx) {
	...
	band.innerHTML =
		'<div class="device-view__destinations-head"><h3 style="margin:0">Mapping nodes</h3><button type="button" class="header-btn" data-add-mapping title="Add mapping node">+</button></div><div class="device-view__ports" data-mapping-nodes></div>'
