...
export function initScenesEditor(root, stateStore, opts = {}) {
	...
	const { globalTakeFromPreview, globalCutFromPreview } = createGlobalPreviewTakeCut({
		sceneState,
		showScenesToast,
		getTakeSceneToProgram: () => takeSceneToProgram,
	})
