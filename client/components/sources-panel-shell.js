...
export function mountSourcesPanelShell(root) {
	...
	return {
		...
		hapBtn: root.querySelector('#sources-hap-selected'),
		hapCancelBtn: root.querySelector('#sources-hap-cancel'),
