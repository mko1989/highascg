...
export const PIP_OVERLAYS = [
	...
	},
	{
		...
		schema: [
			...
			{ key: 'opacity', label: 'Opacity', type: 'float', min: 0, max: 1, step: 0.05, decimals: 2, default: 1, slider: true },
			{ key: 'color', label: 'Color', type: 'color', default: '#e63946' },
			{ key: 'color2Enabled', label: 'Enable secondary color', type: 'bool', default: false },
			{ key: 'color2', label: 'Secondary Color', type: 'color', default: '#0aa5e5' },
			{
				key: 'colorCycleSec',
				label: 'Color transition (sec, first → second)',
				type: 'float',
				min: 0.2,
				max: 20,
				step: 0.1,
