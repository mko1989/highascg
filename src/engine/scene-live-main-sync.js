 ...
 * Keep in sync with client/lib/scene-live-main-sync.js (WO-63).
 *
 ...
 * @returns {{ liveSceneIdByMain: (string|null)[], previewSceneIdByMain: (string|null)[], changed: boolean }}
 */
function syncMainSlotsFromSceneLive(channels, channelMap, sceneExists, prev = {}) {
	...
	return { liveSceneIdByMain, previewSceneIdByMain, changed }
}
 ...
 */
function resolveBusLookIdsForMain(mainIdx, sceneLive, channelMap, sceneExists, sceneStateFallback) {
...
module.exports = { syncMainSlotsFromSceneLive, resolveBusLookIdsForMain, MAX_MAINS }
