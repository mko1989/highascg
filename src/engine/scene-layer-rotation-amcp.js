 ...
 * @see client/lib/scene-layer-rotation-amcp.js (ESM mirror)
 */

const SCENE_LAYER_ROTATION_ANCHOR_X = 0.5
const SCENE_LAYER_ROTATION_ANCHOR_Y = 0.5
 ...
 */
function fillForSceneLayerRotationAnchor(fill, rotationDegrees) {
 ...
 * @returns {string[]}
 */
function sceneLayerRotationMixerLines(cl, rotationDegrees, opts = {}) {
	const rot = Number(rotationDegrees) || 0
...
module.exports = {
	SCENE_LAYER_ROTATION_ANCHOR_X,
	SCENE_LAYER_ROTATION_ANCHOR_Y,
