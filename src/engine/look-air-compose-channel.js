...
const { resolveBusLookIdsForMain } = require('./scene-live-main-sync')

/**
 * Resolve Caspar compose-preview channel when a look is on PGM or PRV (WO-63).
 * Keep in sync with client/lib/look-air-compose-channel.js.
 *
 * @param {string} lookId
 ...
 */
function resolveLookAirComposeChannel(lookId, mainIdx, sceneState, channelMap, sceneLive) {
...
module.exports = { resolveLookAirComposeChannel }
