...
const routesMediaHap = require('./routes-media-hap')
...
routes.get('/api/system/apps', ({ path, ctx, query }) => routesSystemHardware.hardwareHandleGet(path, ctx, query), { requireCaspar: false })
...
routes.post('/api/media/hap-encode', ({ body, ctx }) => routesMediaHap.handleHapEncodeStart(body, ctx), { requireCaspar: false }) // WO-575
routes.post('/api/media/hap-encode/probe', ({ body, ctx }) => routesMediaHap.handleHapEncodeProbe(body, ctx), { requireCaspar: false })
routes.post('/api/media/hap-encode/cancel', ({ body, ctx }) => routesMediaHap.handleHapEncodeCancel(body, ctx), { requireCaspar: false })
routes.get('/api/media/hap-encode', ({ ctx }) => routesMediaHap.handleHapEncodeState(ctx), { requireCaspar: false })
...
const { makeRouteRequest } = require('./router-dispatch')

const routeRequest = makeRouteRequest(routes)
