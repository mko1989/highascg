...
| WO-278 | Cable render performance; allow re-grabbing a cable end and reconnecting it elsewhere | M | **DONE** — renderer was NOT the bottleneck (0.05ms/pass); the 3s xrandr-cache round trip was (274ms cold vs 43ms warm). Prewarm on arm + cable end re-grab with restore-on-invalid |
