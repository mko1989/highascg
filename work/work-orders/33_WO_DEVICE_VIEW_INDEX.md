...
| **40** | [40_WO_DEVICE_VIEW_GPU_XRANDR_SCREEN_DEST_SYNC.md](./40_WO_DEVICE_VIEW_GPU_XRANDR_SCREEN_DEST_SYNC.md) | GPU `xrandr` mode/pos from bound **screen destinations**; Override path; multi-head retile | 33a, 33b, 35; design: [GPU_SCREEN_CONSUMER_AND_XRANDR.md](../../docs/reference/GPU_SCREEN_CONSUMER_AND_XRANDR.md), [screen-consumer-vsync-nvidia.md](../../docs/reference/screen-consumer-vsync-nvidia.md) |
