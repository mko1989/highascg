...
**Status:** Implemented on server — `src/audio/alsa-mixer.js`, routes in `src/api/routes-audio.js`. Canonical doc: [`docs/reference/audio/alsa-mixer-api.md`](../docs/reference/audio/alsa-mixer-api.md).
