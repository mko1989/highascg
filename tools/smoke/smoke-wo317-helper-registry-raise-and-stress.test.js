 ...
 * Pure registry logic tests: kiosk top-assert refcount, listHelpers ordering, park/raise decision
 * table (decideRaise), multi-helper independence, and a many-helpers stress lifecycle.
 *
 * Split from tools/smoke/smoke-wo317-helper-registry.test.js (which keeps create/register,
 * mapped/gone transitions, parked state, and open count) to stay under the 480-line file cap.
 */
