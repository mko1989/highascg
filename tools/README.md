...
| [start-highascg.sh](start-highascg.sh) | Minimal `node index.js` launcher under `/home/casparcg/highascg` |
...
**Default ready file:** `/home/casparcg/highascg/data/caspar-armed` — align with **`CASPAR_ARM_FILE`** on HighAsCG.

**Example** (adjust paths; copy or symlink `tools/` under `/home/casparcg/highascg/tools/`):

```bash
/home/casparcg/highascg/tools/start-highascg.sh >> /tmp/highascg.log 2>&1 &
/home/casparcg/highascg/tools/casparcg-staged-start.sh >> /tmp/caspar-staged.log 2>&1 &
```
