...
LIVE_EXTRA='console=tty0 fbcon=nodefer nosplash loglevel=7 systemd.show_status=true nvidia-drm.modeset=1 nvidia-drm.fbdev=1'
...
patch_one() {
	...
	sed -i \
		-e 's/set gfxpayload=auto/set gfxpayload=text/g' \
